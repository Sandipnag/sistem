...
const Walkthrough = (props) => {
    ...
    const textArr = [
        ...
        },
        {
            ...
            bottomContent: 'Talk to tutors, message them in In real-time and request a online or in-person session',
            buttonText: "Next"
        },
        {
        ...
        },
        {
            ...
            bottomContent: 'Turn your knowledge into extra cash. Teach from a variety for STEM Subjects',
    ...
    return (
        <SafeAreaView style={styles.safeAreaViewconatiner}>
            <View style={styles.container}>
                ...
                <View style={{ alignSelf: 'center', justifyContent: 'center', alignItems: 'center', paddingHorizontal: wp('10%') }}>
                    <Text style={styles.upperContent}>{textArr[contentId].upperContent}</Text>
                    <Text style={styles.bottomContent}>{textArr[contentId].bottomContent}</Text>
                </View>
                <PlainButton
